    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insert.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(word.length() == 0){ Toast.makeText(ListViewEditing.this, "삽입할 단어를 입력하세요 !!!", Toast.LENGTH_LONG).show();
                return;
                }
                list.add(word);
        ...
        delete.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(pos < 0 || pos >= list.size()){Toast.makeText(ListViewEditing.this, "선택하고 삭제를 누르세요 !!!", Toast.LENGTH_LONG).show();
                return;
                }
                //데이터 삭제
                list.remove(pos);
